...
DEPREL_TO_ID = {PAD_TOKEN: 0, UNK_TOKEN: 1, 'SBV':2, 'VOB':3, 'POB':4, 'ADV':5, 'CMP':6, 'ATT':7, 'F':8, 'COO':9, 'DBL':10, 'DOB':11, 'VV':12, 'IC':13, 'MT':14, 'HED':15 }
...
LABEL_TO_ID = {'Drive': 0, 'Own': 1, 'Take': 2, 'Crash': 3, 'Bear': 4, 'Insure': 5, 'Suffer': 6, 'Conduct': 7, 'Other': 8}
